# Astera-org/rejuv-parse-splitseq: Usage

> _Documentation of pipeline parameters is generated automatically from the pipeline schema and can no longer be found in markdown files._

## Introduction

<!-- TODO Add documentation about anything specific to running the pipeline. -->
...
```console
nextflow run Astera-org/rejuv-parse-splitseq --input samplesheet.csv --genome GRCh37 -profile docker
```
...
```console
nextflow pull Astera-org/rejuv-parse-splitseq
```
...
First, go to the [Astera-org/rejuv-parse-splitseq releases page](https://github.com/Astera-org/rejuv-parse-splitseq/releases) and find the latest version number - numeric only (eg. `1.3.1`). Then specify this when running the pipeline with `-r` (one hyphen) - eg. `-r 1.3.1`.
